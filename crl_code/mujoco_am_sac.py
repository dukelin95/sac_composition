...
def run_experiment(variant):
    ...
    if args.domain=='ant-cross-maze':
        ...
        goal_size=2
        sub_level_policies_paths.append("primitive-policies/ant/fwrd/itr_5000.pkl")
        sub_level_policies_paths.append("primitive-policies/ant/bwrd/itr_5000.pkl")
        sub_level_policies_paths.append("primitive-policies/ant/uwrd/itr_5000.pkl")
        sub_level_policies_paths.append("primitive-policies/ant/dwrd/itr_5000.pkl")
        ...
        goal_size=2
        sub_level_policies_paths.append("primitive-policies/hc/fwd/itr_2000.pkl")
        sub_level_policies_paths.append("primitive-policies/hc/jp-longz/itr_2000.pkl")
    elif args.domain=='pusher':
        domain=PusherEnv
        goal_size=0
        sub_level_policies_paths.append("primitive-policies/pusher/bottom/itr_500.pkl")
        sub_level_policies_paths.append("primitive-policies/pusher/left/itr_500.pkl")
    ...
    # not actually doing anything? no params set
