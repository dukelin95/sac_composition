...
class HalfCheetahHurdleEnv(HalfCheetahEnv):
    ...
    def step(self, action):
        ...
        ):  # or (xyz_pos_after[0]-xyz_pos_before[0])<-0.01:#dist_from_hurdle < 1 and dist_from_hurdle > 0.3 and z_after<0.05:(xyz_pos_after[0]-xyz_pos_before[0])<-0.01: #
        ...
        goal_reward = 0
        goal_distance = np.linalg.norm(xyz_position -
                                       self.exteroceptive_observation)
